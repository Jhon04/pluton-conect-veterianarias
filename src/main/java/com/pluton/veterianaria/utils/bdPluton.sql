...
CREATE TABLE USUARIO (
	...
	fech_fin_usu DATETIME DEFAULT CURRENT_TIMESTAMP
);
...
FOREIGN KEY (id_cita_reserva_atencion) REFERENCES CITA_RESERVA_ATENCION (id_cita_reserva_atencion);

/*----------------------------------*/
/*RELACIONES DE TABLAS @RomaDaSilva */
/*----------------------------------*/
ALTER TABLE RAZA
ADD CONSTRAINT FK_RAZA_TIPO_MASCOTA
...
ALTER TABLE CITA_RESERVA_ATENCION
